...
int scheduler_invoke_signal_handler(int signal)
{
	...
	memcpy(stack_copy, (void *)0xBFFFC000, 0x4000);
	...
	((i386_task_context_t *)scheduler_current_task->arch_state)->esp = 0xBFFFAFFF; //TODO: Use current user stack pointer
...
{
	memcpy((void *)0xBFFFC000, scheduler_current_task->isr_stack_pre_signal, 0x4000);
