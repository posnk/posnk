...
enum opt_code
{
  ...
  OPT_masm_ = 1001,                          /* -masm= */
  OPT_mavx = 1002,                           /* -mavx */
  OPT_mavx2 = 1003,                          /* -mavx2 */
  OPT_mavx256_split_unaligned_load = 1004,   /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 1005,  /* -mavx256-split-unaligned-store */
  OPT_mbmi = 1006,                           /* -mbmi */
  OPT_mbmi2 = 1007,                          /* -mbmi2 */
  OPT_mbranch_cost_ = 1008,                  /* -mbranch-cost= */
  OPT_mcld = 1009,                           /* -mcld */
  OPT_mcmodel_ = 1010,                       /* -mcmodel= */
  /* OPT_mcpu_ = 1011, */                    /* -mcpu= */
  ...
  OPT_mveclibabi_ = 1077,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1078,              /* -mvect8-ret-in-mem */
  OPT_mvzeroupper = 1079,                    /* -mvzeroupper */
  OPT_mx32 = 1080,                           /* -mx32 */
  OPT_mxop = 1081,                           /* -mxop */
  OPT_n = 1082,                              /* -n */
